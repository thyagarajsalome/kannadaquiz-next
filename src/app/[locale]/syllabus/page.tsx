...
const examsList: ExamSyllabusCard[] = [
  ...
  {
    id: "sslc",
    title: "Karnataka SSLC (Class 10 Board Exam)",
    category: "Secondary Education (KSEAB)",
    duration: "6 Subjects Written Exams",
    marks: "625 Marks Total",
    description: "Access Karnataka Class 10 SSLC subject-wise syllabus, exam pattern, blueprint, and chapter-wise weightage for Core Subjects & Languages.",
    kannadaTitle: "ಕರ್ನಾಟಕ SSLC (10ನೇ ತರಗತಿ ಬೋರ್ಡ್ ಪರೀಕ್ಷೆ)",
    kannadaCategory: "ಪ್ರೌಢಶಿಕ್ಷಣ ಮಂಡಳಿ (KSEAB)",
    kannadaDuration: "6 ಮುಖ್ಯ ಪತ್ರಿಕೆಗಳು (ಲಿಖಿತ ಪರೀಕ್ಷೆ)",
    kannadaMarks: "ಒಟ್ಟು 625 ಅಂಕಗಳು",
    kannadaDescription: "ಕರ್ನಾಟಕ 10ನೇ ತರಗತಿ SSLC ಪರೀಕ್ಷೆಯ ವಿಷಯವಾರು ಪಠ್ಯಕ್ರಮ, ಬ್ಲೂಪ್ರಿಂಟ್, ಅಧ್ಯಾಯವಾರು ಅಂಕಗಳ ಹಂಚಿಕೆ ಮತ್ತು ಮಾದರಿ ಪ್ರಶ್ನೆ ಪತ್ರಿಕೆಗಳ ವಿವರ.",
    path: "/syllabus/sslc",
    color: "from-amber-500 to-orange-600",
  },
  {
    id: "puc",
    title: "Karnataka 2nd PUC (Class 12 Board Exam)",
    category: "Pre-University Education (KSEAB)",
    duration: "Science, Commerce & Arts Streams",
    marks: "600 Marks Total",
    description: "Get the latest 2nd PUC syllabus and question paper design for Physics, Chemistry, Maths, Biology, Accountancy, and other major streams.",
    kannadaTitle: "ಕರ್ನಾಟಕ ದ್ವಿತೀಯ PUC (12ನೇ ತರಗತಿ ಬೋರ್ಡ್ ಪರೀಕ್ಷೆ)",
    kannadaCategory: "ಪದವಿ ಪೂರ್ವ ಶಿಕ್ಷಣ ಮಂಡಳಿ (KSEAB)",
    kannadaDuration: "ವಿಜ್ಞಾನ, ವಾಣಿಜ್ಯ ಮತ್ತು ಕಲಾ ವಿಭಾಗಗಳು",
    kannadaMarks: "ಒಟ್ಟು 600 ಅಂಕಗಳು",
    kannadaDescription: "ದ್ವಿತೀಯ ಪಿಯುಸಿ ಬೋರ್ಡ್ ಪರೀಕ್ಷೆಯ ನೂತನ ಪಠ್ಯಕ್ರಮ, ಮಾದರಿ ಪ್ರಶ್ನೆ ಪತ್ರಿಕೆಯ ವಿನ್ಯಾಸ, ಲ್ಯಾಬ್ ಪ್ರಾಯೋಗಿಕ ಪರೀಕ್ಷೆಗಳು ಮತ್ತು ಮಾರ್ಗದರ್ಶಿಗಳು.",
    path: "/syllabus/puc",
