        ...
        {locale === "kn" ? (
          <>
            <section className="space-y-3">
              <h2 className="font-serif text-lg font-bold text-[var(--primary)]">೧. ಶೈಕ್ಷಣಿಕ ಮತ್ತು ಮಾಹಿತಿ ಉದ್ದೇಶ ಮಾತ್ರ</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="font-serif text-lg font-bold text-[var(--primary)]">೨. ನ್ಯಾಯಯುತ ಬಳಕೆ ಹಕ್ಕುತ್ಯಾಗ (Fair Use Disclaimer)</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="font-serif text-lg font-bold text-[var(--primary)]">೩. ಮೂಲ ಮಾಲೀಕತ್ವ ಮತ್ತು ಗೌರವ ಸೂಚನೆ</h2>
              <p>
            ...
            <section className="space-y-3">
              <h2 className="font-serif text-lg font-bold text-[var(--primary)]">೪. ಹೊಣೆಗಾರಿಕೆಯ ಮಿತಿ</h2>
              <p>
