...
const EDUCATION_DATA: EduCategory[] = [
  ...
  },
  {
    ...
    items: [
      { id: "ba", name: "BA (Bachelor of Arts)", nameKn: "ಬಿ.ಎ (Bachelor of Arts)", desc: "3 to 4-year degree focusing on humanities, social sciences, literature, and languages.", descKn: "ಮಾನವಿಕ ವಿಷಯಗಳು, ಸಮಾಜ ವಿಜ್ಞಾನ, ಸಾಹಿತ್ಯ ಮತ್ತು ಭಾಷೆಗಳ ಮೇಲೆ ಕೇಂದ್ರೀಕೃತವಾದ 3 ರಿಂದ 4 ವರ್ಷಗಳ ಪದವಿ." },
      { id: "bsc", name: "BSc (Bachelor of Science)", nameKn: "ಬಿ.ಎಸ್ಸಿ (Bachelor of Science)", desc: "Degree in pure sciences (Physics, Chemistry, Math, Biology) or applied sciences (Computer Science, Agriculture).", descKn: "ಭೌತಶಾಸ್ತ್ರ, ರಸಾಯನಶಾಸ್ತ್ರ, ಗಣಿತ, ಜೀವಶಾಸ್ತ್ರ ಮುಂತಾದ ವಿಜ್ಞಾನ ವಿಷಯಗಳನ್ನು ಒಳಗೊಂಡಿರುವ ಪದವಿ." },
      { id: "bcom", name: "BCom (Bachelor of Commerce)", nameKn: "ಬಿ.ಕಾಂ (Bachelor of Commerce)", desc: "Degree in commerce, accounting, finance, and business studies.", descKn: "ವಾಣಿಜ್ಯ, ಲೆಕ್ಕಪತ್ರ ನಿರ್ವಹಣೆ (Accounting), ಹಣಕಾಸು ಮತ್ತು ವ್ಯಾಪಾರ ಅಧ್ಯಯನಗಳ ಪದವಿ." },
      { id: "bca", name: "BCA (Bachelor of Computer Applications)", nameKn: "ಬಿ.ಸಿ.ಎ (BCA)", desc: "Software and application development focused undergraduate degree.", descKn: "ಸಾಫ್ಟ್‌ವೇರ್ ಮತ್ತು ಕಂಪ್ಯೂಟರ್ ಅಪ್ಲಿಕೇಶನ್ ಅಭಿವೃದ್ಧಿಯ ಬಗ್ಗೆ ಆಳವಾದ ಜ್ಞಾನ ನೀಡುವ ಪದವಿ." },
      { id: "bba", name: "BBA (Bachelor of Business Administration)", nameKn: "ಬಿ.ಬಿ.ಎ (BBA)", desc: "Degree focused on business management, entrepreneurship, and corporate leadership.", descKn: "ವ್ಯಾಪಾರ ನಿರ್ವಹಣೆ, ಕಾರ್ಪೊರೇಟ್ ನಾಯಕತ್ವ ಮತ್ತು ಉದ್ಯಮಶೀಲತೆಯ ಮೇಲಿನ ಪದವಿ." },
