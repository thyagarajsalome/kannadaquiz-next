...
export default function NotFound() {
  return (
    <div className="kq-container flex flex-col items-center justify-center py-20 text-center">
      ...
      {/* Kannada version */}
      <div className="mb-6">
        <h1 className="font-serif text-3xl font-bold text-[var(--primary)]">ಪುಟ ಕಂಡುಬಂದಿಲ್ಲ</h1>
      ...
      <div className="w-16 h-[1px] bg-[var(--border)] my-4"></div>

      {/* English version */}
      <div className="mb-8">
        <h2 className="font-serif text-xl font-bold text-[var(--primary)] opacity-80">Page Not Found</h2>
        <p className="mt-2 text-xs text-[var(--muted)] max-w-sm mx-auto leading-relaxed">
