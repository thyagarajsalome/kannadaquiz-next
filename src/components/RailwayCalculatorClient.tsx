...
export function RailwayCalculatorClient({ locale }: { locale: Locale }) {
  ...
  const t = {
    kn: {
      ...
      timeGT_48H: "48 ಗಂಟೆಗಿಂತ ಮೊದಲು",
      time48H_12H: "48 ಗಂಟೆಯಿಂದ 12 ಗಂಟೆಯ ನಡುವೆ",
      time12H_4H: "12 ಗಂಟೆಯಿಂದ 4 ಗಂಟೆಯ ನಡುವೆ (ಚಾರ್ಟ್ ತಯಾರಿಕೆಗೆ ಮುನ್ನ)",
      timeLT_4H: "4 ಗಂಟೆಗಿಂತ ಕಡಿಮೆ (ಚಾರ್ಟ್ ತಯಾರಿಕೆಗೆ ನಂತರ)",
      ...
      actionTatkalNoRefund: "ಖಚಿತಪಟ್ಟ ತತ್ಕಾಲ್ ಟಿಕೆಟ್‌ಗೆ ಯಾವುದೇ ಮರುಪಾವತಿ ಲಭ್ಯವಿರುವುದಿಲ್ಲ (100% ಕಡಿತ).",
      actionWLAuto: "ವೇಟ್‌ಲಿಸ್ಟ್ ಇ-ಟಿಕೆಟ್ ಚಾರ್ಟ್ ತಯಾರಿಕೆಯ ನಂತರ ಸ್ವಯಂಚಾಲಿತವಾಗಿ ರದ್ದಾಗುತ್ತದೆ ಮತ್ತು ಕೇವಲ ₹60 ಕಡಿತದೊಂದಿಗೆ ಪೂರ್ತಿ ಹಣ ಬ್ಯಾಂಕ್ ಖಾತೆಗೆ ಜಮೆಯಾಗುತ್ತದೆ.",
      backLink: "🏛️ ಸರ್ಕಾರಿ ಸೇವೆಗಳ ಮುಖಪುಟಕ್ಕೆ ಹಿಂತಿರುಗಿ",
      ruleBookTitle: "ಭಾರತೀಯ ರೈಲ್ವೆ ರದ್ದತಿ ಶುಲ್ಕಗಳ ಕೋಷ್ಟಕ (ಕನಿಷ್ಠ ಕಡಿತ)",
      ruleClass: "ವರ್ಗ",
      ruleMinFee: "ಕನಿಷ್ಠ ರದ್ದತಿ ಶುಲ್ಕ (>48 ಗಂಟೆಗಳ ಮೊದಲು)",
      class1AC: "ಎಸಿ ಫಸ್ಟ್ ಕ್ಲಾಸ್ / ಎಕ್ಸಿಕ್ಯೂಟಿವ್",
      class2AC: "ಎಸಿ 2 ಟೈರ್ / ಫಸ್ಟ್ ಕ್ಲಾಸ್",
      class3AC: "ಎಸಿ 3 ಟೈರ್ / ಚೇರ್ ಕಾರ್",
      ...
      <div className="mt-12 bg-white border border-[var(--border)]/70 rounded-2xl p-6 md:p-8 shadow-sm space-y-6">
        ...
        <div className="bg-amber-50 border border-amber-200/50 rounded-xl p-5 text-xs md:text-sm text-amber-900 space-y-3">
          ...
          <ul className="list-disc pl-5 space-y-2 leading-relaxed">
            {locale === "kn" ? (
              <>
                <li><strong>ತತ್ಕಾಲ್ ಕನ್ಫರ್ಮ್ ಟಿಕೆಟ್</strong>: ಕನ್ಫರ್ಮ್ ಆದ ತತ್ಕಾಲ್ ಟಿಕೆಟ್ ರದ್ದು ಮಾಡಿದರೆ ಯಾವುದೇ ಹಣ ವಾಪಸ್ ಸಿಗುವುದಿಲ್ಲ (100% ಕಡಿತ).</li>
                <li><strong>ವೇಟ್‌ಲಿಸ್ಟ್ ತತ್ಕಾಲ್</strong>: ವೇಟ್‌ಲಿಸ್ಟ್ ತತ್ಕಾಲ್ ಟಿಕೆಟ್‌ಗೆ ಕೇವಲ ₹60 ಕ್ಲರ್ಕೇಜ್ ಶುಲ್ಕ ಕಡಿತವಾಗಿ ಉಳಿದ ಹಣ ಮರುಪಾವತಿಯಾಗುತ್ತದೆ.</li>
                <li><strong>ರೈಲು ತಡವಾಗಿ ಬಂದರೆ</strong>: ರೈಲು 3 ಗಂಟೆಗಿಂತ ಹೆಚ್ಚು ತಡವಾಗಿ ಚಲಿಸುತ್ತಿದ್ದರೆ, ಪ್ರವಾಸ ಆರಂಭವಾಗುವ ಮುನ್ನ ಆನ್‌ಲೈನ್ ಟಿಡಿಆರ್ (TDR) ಸಲ್ಲಿಸಿ ಪೂರ್ಣ ಹಣವನ್ನು ರದ್ದತಿ ಶುಲ್ಕವಿಲ್ಲದೆ ಪಡೆಯಬಹುದು.</li>
